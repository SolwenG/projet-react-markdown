...
export const addMarkdownFile = createAsyncThunk(
  'markdown/addFile',
  async (fileDetails) => {
...
export const removeMarkdownFile = createAsyncThunk(
  'markdown/removeFile',
  async (id) => {
...
export const editMarkdownFile = createAsyncThunk(
  'markdown/editFile',
  async ({ id, changes }) => {
...
export const clearMarkdownFiles = createAsyncThunk(
  'markdown/clearFiles',
  async () => {
...
export const moveFile = createAsyncThunk(
  ...
  async ({ fileId, targetFolderId }) => {
    const updatedFile = await updateMdFile(fileId, {
